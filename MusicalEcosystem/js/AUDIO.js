...
var whiteNotes = [-12,-10,-8,-7,-5,-3,-1,0,1,2,4,5,7,9,11,12];
...
function soundEvent(volume, attack, release) {
    ...
    //create the oscilator and gain nodes//
    var osc = new Tone.Oscillator(note);
    var amp = audioCtx.createGain();

    //conect the oscillator and gain to the output//
    osc.connect(amp);
    amp.connect(output);
    ...
    //start the sound and schduel it stopping//
    osc.start();
